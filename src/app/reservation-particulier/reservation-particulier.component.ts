...
import { AdresseGoogleApi, CreerReservation, PlaceAdress, ReserverAfficherAnnonce } from '../domains';
import { ReservationService } from '../services/reservation.service';

@Component({
  selector: 'app-reservation-particulier',
  templateUrl: 'reservation-particulier.component.html',
  styles: []
})
export class ReservationParticulierComponent implements OnInit {
  ...
  constructor(private _mapsAPILoader: MapsAPILoader, private ngZone: NgZone, public creerReservationService: ReservationService, public router: Router) {
